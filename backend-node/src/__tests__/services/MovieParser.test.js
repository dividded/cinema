...
describe('MovieParser', () => {
    it('should parse movie data from HTML', () => {
        // Given
        const htmlContent = fs_1.default.readFileSync(path_1.default.join(__dirname, '../../__fixtures__/sample-movie-page.html'), 'utf-8');
        const dom = new jsdom_1.JSDOM(htmlContent);
        const document = dom.window.document;
        // When
        const movies = MovieParser_1.MovieParser.parse(document);
        // Then
    ...
    it('should parse movie with english alt name and metadata correctly', () => {
        // Given
        const htmlContent = fs_1.default.readFileSync(path_1.default.join(__dirname, '../../__fixtures__/cinema_co_il_schedule.html'), 'utf-8');
        const dom = new jsdom_1.JSDOM(htmlContent);
        const document = dom.window.document;
        // When
        ...
        expect(movie === null || movie === void 0 ? void 0 : movie.year).toBe(2023);
        expect(movie === null || movie === void 0 ? void 0 : movie.altName).toBe('Ex-Husbands');
        expect(movie === null || movie === void 0 ? void 0 : movie.imgUrl).toBe('https://www.cinema.co.il/wp-content/uploads/2024/08/הבעלים-לשעבר.jpg');
        expect(movie === null || movie === void 0 ? void 0 : movie.siteUrl).toBe('https://www.cinema.co.il/event/%d7%94%d7%91%d7%a2%d7%9c%d7%99%d7%9d-%d7%9c%d7%a9%d7%a2%d7%91%d7%a8/');
        const screening = movie === null || movie === void 0 ? void 0 : movie.screenings.find(s => s.dateTime === '2025-01-25 11:30' &&
    ...
    it('should parse movie with english alt name from description correctly', () => {
        ...
        expect(movie).toBeDefined();
        expect(movie === null || movie === void 0 ? void 0 : movie.altName).toBe('The Story of Souleymane');
    });
    it('should parse at least 5 movies from another examples fixture', () => {
        // Given
        const htmlContent = fs_1.default.readFileSync(path_1.default.join(__dirname, '../../__fixtures__/cinema_co_another_examples.html'), 'utf-8');
        const dom = new jsdom_1.JSDOM(htmlContent);
        const document = dom.window.document;
        // When
        const movies = MovieParser_1.MovieParser.parseFromDateHtml(document);
    ...
    it('should parse specific movie with all metadata', () => {
        ...
        expect(movie).toBeDefined();
        expect(movie === null || movie === void 0 ? void 0 : movie.title).toBe('סוף שבוע בגליל | תרגום לצרפתית');
